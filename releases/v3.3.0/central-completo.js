/* ==============================================================
 *  CENTRAL DE AUTOMAÇÃO — ARQUIVO DE RESERVA · versão 3.3.0
 *
 *  NÃO EDITE ESTE ARQUIVO À MÃO.
 *  Ele é gerado por ferramentas/gerar-reserva.py juntando
 *  todos os módulos de src/. Mexa nos módulos e gere de novo.
 *
 *  Ele existe por um motivo só: se algum módulo não baixar,
 *  o carregador cai aqui e a equipe continua trabalhando.
 * ============================================================== */
(function () {
    "use strict";
 ...
 * ---------------------------------------------------------- */
/* ============================================================
 *  LOGOTIPOS DOS CONVÊNIOS
 *  Imagens embutidas em base64 — não dependem de internet nem
 *  de nenhum site externo. Copiadas do central.js v2.1.0 sem
 *  nenhuma alteração.
 *
 *  Para trocar uma logo: substitua a linha inteira do convênio.
 *  Para acrescentar: acrescente uma linha "Nome do card": "data:...".
 *  O nome tem que ser IGUAL ao rótulo do card em convenios.js.
 * ============================================================ */
(function (CR) {
    "use strict";
